...
from tensorflow_probability.python.internal.backend.jax import composite_tensor
from tensorflow_probability.python.internal.backend.jax import composite_tensor_gradient
...
from tensorflow_probability.python.internal.backend.jax import type_spec_registry
...
from tensorflow_probability.python.internal.backend.jax import variables
...
from tensorflow_probability.python.internal.backend.jax.gen import property_hint_util
from tensorflow_probability.python.internal.backend.jax.gen import slicing
from absl import logging as logging
from tensorflow_probability.python.internal.backend.jax import data_structures
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  def _linop_matmul(
    ...
    # instance of linear_operator_zeros.LinearOperatorZeros
      ...
      from tensorflow_probability.python.internal.backend.jax.gen import linear_operator_composition  # pylint: disable=g-import-not-at-top
  ...
  def _linop_solve(
    ...
    # errors due to this cyclic dependency.
    from tensorflow_probability.python.internal.backend.jax.gen import linear_operator_composition  # pylint: disable=g-import-not-at-top
    from tensorflow_probability.python.internal.backend.jax.gen import linear_operator_inversion  # pylint: disable=g-import-not-at-top
  ...
  def _linop_adjoint(self) -> "LinearOperator":
    from tensorflow_probability.python.internal.backend.jax.gen import linear_operator_adjoint  # pylint: disable=g-import-not-at-top
  ...
  def _linop_cholesky(self) -> "LinearOperator":
    from tensorflow_probability.python.internal.backend.jax.gen import linear_operator_lower_triangular  # pylint: disable=g-import-not-at-top
    ...
    if k in op._composite_tensor_prefer_static_fields and kwargs[k] is not None:  # pylint: disable=protected-access
      if ops.is_tensor(kwargs[k]):
        ...
        if static_val is not None:
          kwargs[k] = static_val
    if isinstance(kwargs[k], (np.ndarray, onp.generic)):
