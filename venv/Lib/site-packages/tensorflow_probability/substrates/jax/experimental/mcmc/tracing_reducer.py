...
from tensorflow_probability.substrates.jax.experimental.mcmc import reducer as reducer_base
...
#   `tensorflow_probability/substrates/jax/experimental/mcmc/tracing_reducer.py`
