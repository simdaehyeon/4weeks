...
from tensorflow_probability.substrates.jax.experimental.linalg import linear_operator_unitary
...
class MultiTaskGaussianProcess(distribution.AutoCompositeTensorDistribution):
  ...
  def posterior_predictive(
    ...
    Returns:
      mtgprm: An instance of `Distribution` that represents the posterior
        predictive.
    """
    from tensorflow_probability.substrates.jax.experimental.distributions import multitask_gaussian_process_regression_model as mtgprm  # pylint:disable=g-import-not-at-top
  ...
  def _parameter_properties(cls, dtype, num_classes=None):
    from tensorflow_probability.substrates.jax.bijectors import softplus as softplus_bijector  # pylint:disable=g-import-not-at-top
    return dict(
...
#   `tensorflow_probability/substrates/jax/experimental/distributions/multitask_gaussian_process.py`
