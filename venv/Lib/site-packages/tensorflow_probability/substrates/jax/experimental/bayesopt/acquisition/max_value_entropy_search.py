...
from tensorflow_probability.substrates.jax.math import root_search
from tensorflow_probability.substrates.jax.math import special
...
#   `tensorflow_probability/substrates/jax/experimental/bayesopt/acquisition/max_value_entropy_search.py`
