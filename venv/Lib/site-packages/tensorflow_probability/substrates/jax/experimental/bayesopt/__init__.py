...
from tensorflow_probability.substrates.jax.experimental.bayesopt import acquisition
...
#   `tensorflow_probability/substrates/jax/experimental/bayesopt/__init__.py`
