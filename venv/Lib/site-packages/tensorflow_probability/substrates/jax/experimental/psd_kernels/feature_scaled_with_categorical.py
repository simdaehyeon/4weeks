...
class FeatureScaledWithCategorical(psd_kernel.AutoCompositeTensorPsdKernel):
  ...
  def _parameter_properties(cls, dtype):
    from tensorflow_probability.substrates.jax.bijectors import joint_map  # pylint:disable=g-import-not-at-top
...
#   `tensorflow_probability/substrates/jax/experimental/psd_kernels/feature_scaled_with_categorical.py`
