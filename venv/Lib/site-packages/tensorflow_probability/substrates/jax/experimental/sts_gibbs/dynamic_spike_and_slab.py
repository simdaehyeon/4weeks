...
from tensorflow_probability.substrates.jax.distributions import sample as sample_dist
...
#   `tensorflow_probability/substrates/jax/experimental/sts_gibbs/dynamic_spike_and_slab.py`
