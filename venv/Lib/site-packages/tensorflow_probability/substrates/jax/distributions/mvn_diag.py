...
from tensorflow_probability.substrates.jax.math import generic
from tensorflow_probability.python.internal.backend.jax.gen import linear_operator  # pylint: disable=g-direct-tensorflow-import
