...
class Distribution(_BaseDistribution):
  ...
  *not* automatically inherit
  ...
  def _params_event_ndims(self):
    ...
    from tensorflow_probability.substrates.jax.internal import parameter_properties  # pylint: disable=g-import-not-at-top
...
class DiscreteDistributionMixin(object):
  ...
  def _experimental_tangent_space(self, x):
    del x
    from tensorflow_probability.substrates.jax.experimental import tangent_spaces  # pylint: disable=g-import-not-at-top
