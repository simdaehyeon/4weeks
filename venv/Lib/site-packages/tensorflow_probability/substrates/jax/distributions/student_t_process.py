...
from tensorflow_probability.substrates.jax.math import linalg
  ...
  def posterior_predictive(
    ...
    Returns:
      stprm: An instance of `Distribution` that represents the posterior
        predictive.
    """
    from tensorflow_probability.substrates.jax.distributions import student_t_process_regression_model as stprm  # pylint:disable=g-import-not-at-top
