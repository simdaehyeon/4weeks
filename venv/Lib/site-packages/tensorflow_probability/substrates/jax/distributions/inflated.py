...
from tensorflow_probability.substrates.jax.distributions import mixture
from tensorflow_probability.substrates.jax.distributions import negative_binomial
...
#   `tensorflow_probability/substrates/jax/distributions/inflated.py`
