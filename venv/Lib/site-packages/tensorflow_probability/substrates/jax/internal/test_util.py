...
from tensorflow_probability.substrates.jax.internal import empirical_statistical_testing
...
class EagerGraphCombination(test_combinations.TestCombination):
  ...
  def context_managers(self, kwargs):
    ...
    from tensorflow_probability.python.internal.backend.jax import private  # pylint: disable=g-direct-tensorflow-import,g-import-not-at-top
