...
class GammaExponential(psd_kernel.AutoCompositeTensorPsdKernel):
  ...
  def _parameter_properties(cls, dtype):
    from tensorflow_probability.substrates.jax.bijectors import sigmoid  # pylint:disable=g-import-not-at-top
...
#   `tensorflow_probability/substrates/jax/math/psd_kernels/gamma_exponential.py`
