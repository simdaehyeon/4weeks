...
class Polynomial(psd_kernel.AutoCompositeTensorPsdKernel):
  ...
  def _parameter_control_dependencies(self, is_init):
    ...
    if ok_to_check(self.exponent):
      ...
      from tensorflow_probability.substrates.numpy.internal import distribution_util  # pylint: disable=g-import-not-at-top
      assertions.append(
...
class Constant(Linear):
  ...
  def __init__(self,
    ...
    with tf.name_scope(name):
      ...
      from tensorflow_probability.substrates.numpy import util as tfp_util  # pylint:disable=g-import-not-at-top
