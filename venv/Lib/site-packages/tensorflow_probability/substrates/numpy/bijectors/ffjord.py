...
from tensorflow_probability.substrates.numpy.math.ode import dormand_prince
...
def trace_jacobian_hutchinson(
    ...
    state_shape,
    dtype,
    sample_fn=tf.random.stateless_normal,
    num_samples=1,
    seed=None):
...
#   `tensorflow_probability/substrates/numpy/bijectors/ffjord.py`
