...
from tensorflow_probability.substrates.numpy.math import special
...
class PowerSpherical(distribution.AutoCompositeTensorDistribution):
  ...
  * `concentration = kappa`; scalar real >= 0, concentration of samples around
  ...
  def _experimental_tangent_space(self, x):
    from tensorflow_probability.substrates.numpy.experimental.tangent_spaces import spherical  # pylint:disable=g-import-not-at-top
