...
from tensorflow_probability.python.internal.backend.numpy import functional_ops as control_flow_ops  # pylint: disable=g-direct-tensorflow-import
  ...
  * TODO(davmre): show example of fitting parameters.
  ...
  def _joint_sample_n(self, n, seed=None):
    if self.experimental_parallelize:
      ...
      from tensorflow_probability.substrates.numpy.experimental.parallel_filter import parallel_kalman_filter_lib as pkf  # pylint:disable=g-import-not-at-top
      x, y = pkf.sample_walk(
          seed=seed,
