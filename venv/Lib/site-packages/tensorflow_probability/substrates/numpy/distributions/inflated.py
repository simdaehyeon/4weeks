...
from tensorflow_probability.substrates.numpy.distributions import mixture
from tensorflow_probability.substrates.numpy.distributions import negative_binomial
...
#   `tensorflow_probability/substrates/numpy/distributions/inflated.py`
