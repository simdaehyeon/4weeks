...
from tensorflow_probability.substrates.numpy.experimental.tangent_spaces import spaces
...
#   `tensorflow_probability/substrates/numpy/experimental/tangent_spaces/symmetric_matrix.py`
