...
from tensorflow_probability.substrates.numpy.experimental.bayesopt import acquisition
...
#   `tensorflow_probability/substrates/numpy/experimental/bayesopt/__init__.py`
