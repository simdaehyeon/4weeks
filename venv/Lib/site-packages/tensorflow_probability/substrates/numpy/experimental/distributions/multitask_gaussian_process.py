...
from tensorflow_probability.substrates.numpy.distributions.internal import stochastic_process_util
from tensorflow_probability.substrates.numpy.experimental.linalg import linear_operator_unitary
from tensorflow_probability.substrates.numpy.experimental.psd_kernels import multitask_kernel
...
class MultiTaskGaussianProcess(distribution.AutoCompositeTensorDistribution):
  ...
  def posterior_predictive(
    ...
    Returns:
      mtgprm: An instance of `Distribution` that represents the posterior
        predictive.
    """
    from tensorflow_probability.substrates.numpy.experimental.distributions import multitask_gaussian_process_regression_model as mtgprm  # pylint:disable=g-import-not-at-top
  ...
  def _parameter_properties(cls, dtype, num_classes=None):
    from tensorflow_probability.substrates.numpy.bijectors import softplus as softplus_bijector  # pylint:disable=g-import-not-at-top
    return dict(
...
#   `tensorflow_probability/substrates/numpy/experimental/distributions/multitask_gaussian_process.py`
