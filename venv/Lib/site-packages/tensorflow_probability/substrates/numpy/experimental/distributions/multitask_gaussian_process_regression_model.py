...
from tensorflow_probability.substrates.numpy.experimental.distributions import multitask_gaussian_process as mtgp
...
#   `tensorflow_probability/substrates/numpy/experimental/distributions/multitask_gaussian_process_regression_model.py`
