...
from tensorflow_probability.substrates.numpy.distributions import sample as sample_dist
...
#   `tensorflow_probability/substrates/numpy/experimental/sts_gibbs/dynamic_spike_and_slab.py`
