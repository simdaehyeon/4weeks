...
from tensorflow_probability.substrates.numpy.internal import empirical_statistical_testing
...
class EagerGraphCombination(test_combinations.TestCombination):
  ...
  def context_managers(self, kwargs):
    ...
    from tensorflow_probability.python.internal.backend.numpy import private  # pylint: disable=g-direct-tensorflow-import,g-import-not-at-top
