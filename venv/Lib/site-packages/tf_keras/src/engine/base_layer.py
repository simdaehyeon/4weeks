...
from tf_keras.src.utils.generic_utils import to_snake_case  # noqa: F401
from tf_keras.src.utils.tf_utils import is_tensor_or_tensor_list  # noqa: F401
...
metrics_mod = generic_utils.LazyLoader(
    "metrics_mod", globals(), "tf_keras.src.metrics"
)
